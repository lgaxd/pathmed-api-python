...
from app.api.v1.endpoints import auth, pacientes, consultas, especialidades, profissionais, disponibilidade
...
api_router.include_router(disponibilidade.router, prefix="/especialidades", tags=["Disponibilidade"])